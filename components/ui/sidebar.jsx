  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar dark:bg-gray-900",
          className
        )}
        {...props}>
        {children}
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          className="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border dark:bg-gray-900">
          {children}
        </div>
      </div>
    </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon-sm"
      className={cn(className, "bg-transparent! hover:bg-[#5F18EA]/10! rounded-[8px]! p-5! dark:text-white dark:hover:bg-gray-200/10!")}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarInset({
  ...
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 dark:bg-gray-800!",
        className
      )}
      {...props} />
  );
