...
export default function HeroDashboard() {
  ...
  return (
    <div className="w-full px-[8vw] py-12 text-zinc-950 transition-colors max-[640px]:px-[6vw] dark:text-zinc-50">
      <div className="mx-auto flex w-full max-w-[1100px] flex-col justify-between gap-10 lg:flex-row lg:items-center lg:gap-14 xl:gap-20">
