      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border bg-card p-4 flex flex-col gap-3 shadow-sm hover:border-[#5E17EB]! sm:col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between">
              <span className="text-sm text-muted-foreground font-medium">Integridade media</span>
              <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                ...
                {loadingInicial ? "Calculando" : integridadeMedia >= 75 ? "Estavel" : integridadeMedia >= 50 ? "Atencao" : "Critico"}
              </span>
            </div>
