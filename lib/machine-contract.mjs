...
const MachineApiRecordSchema = z.object({
  ...
  dataInicioManutencao: z.any().optional(),
  data_inicio_manutencao: z.any().optional(),
  maintenanceStartDate: z.any().optional(),
  previsaoManutencao: z.any().optional(),
  previsao_manutencao: z.any().optional(),
  predictedMaintenanceAt: z.any().optional(),
  dataFalha: z.any().optional(),
  data_falha: z.any().optional(),
