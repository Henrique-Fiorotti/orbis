const PREDICTION_REASON_LABELS = {
  ...
  modelo_nao_pode_ser_calculado: "Modelo nao pode ser calculado",
  tendencia_nao_confiavel: "Tendencia nao confiavel",
  sem_historico_de_alertas_do_tipo: "Sem historico suficiente desse tipo de alerta",
  evento_ja_ocorrido: "Evento ja ocorrido",
  previsao_fora_da_janela: "Previsao fora da janela monitorada",
  ...
  manutencao_imediata: "Manutencao imediata recomendada",
...
const PREDICTION_STATUS_LABELS = {
  PREVISAO_VALIDA: {
    tone: "stable",
    badge: "Previsao valida",
    title: "Previsao calculada",
  ...
  SEM_DADOS: {
    ...
    description: "O backend nao inventou uma previsao porque os dados ainda nao sustentam o calculo.",
  },
  MANUTENCAO_IMEDIATA: {
    tone: "critical",
    badge: "Prioridade imediata",
    title: "Manutencao imediata",
  ...
  FALHA_JA_CRUZADA: {
    ...
    description: "A maquina ja cruzou o limiar critico usado pelo modelo.",
  },
  MODELO_INVALIDO_COM_RISCO: {
    tone: "warning",
    badge: "Modelo fraco",
    title: "Modelo invalido, risco presente",
    description: "A regressao nao e confiavel, mas existem sinais operacionais que pedem acompanhamento.",
  },
}
